...
Route::get('/supplier/ordered-products', [App\Http\Controllers\Frontend\SupplierController::class, 'vendorOrderProduct'])->name('vendor.product.order');
Route::get('/supplier/product/list', [App\Http\Controllers\Frontend\SupplierController::class, 'products'])->name('vendor.product');
...
Route::get('/vendor/product/size/delete/{id}', [\App\Http\Controllers\Admin\AdminController::class, 'sizeDelete']);
Route::get('/vendor/product/color/delete/{id}', [\App\Http\Controllers\Admin\AdminController::class, 'colorDelete']);