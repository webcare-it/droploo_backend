...
use App\Http\Controllers\Admin\DropshipperController;
...
//     });
    ...
    Route::get('/dropshipper-invoice', [\App\Http\Controllers\Admin\ReportController::class, 'dropshipperInvoiceList']);
...
//        Route::get('/complete/{id}', [\App\Http\Controllers\Admin\OrderController::class, 'complete'])->name('order.complete');
    ...
    //Custom Order...
    Route::get('order/add-custom', [\App\Http\Controllers\Admin\AdminController::class, 'addCustomOrder']);
    Route::post('/add-manual-product', [ProductController::class, 'storeManualProduct']);
    Route::post('/checkout-custom', [ProductController::class, 'storeCustomOrder']);
    ...
    //Deposit Reports...
    Route::get('/all-deposit', [\App\Http\Controllers\Admin\AdminController::class, 'depositList']);
    Route::get('/approve-deposit/{id}', [\App\Http\Controllers\Admin\AdminController::class, 'depositApprove']);
    Route::get('/reject-deposit/{id}', [\App\Http\Controllers\Admin\AdminController::class, 'depositReject']);
    //Deposit Reports
    ...
    Route::get('/dropshipper-order/payment/{id}', [\App\Http\Controllers\Admin\DropshipperController::class, 'dropshipperPayment']);
    Route::get('/dropshipper-order/manual-payment/{id}', [\App\Http\Controllers\Admin\DropshipperController::class, 'dropshipperManualPayment']);
    Route::post('/dropshipper-order/manual-payment-store/{id}', [\App\Http\Controllers\Admin\DropshipperController::class, 'dropshipperManualPaymentStore']);
    //Order Payment to Dropshipper...

    //Set Order TrackingId....
    Route::get('/dropshipper-order/set-tracking-link/{orderId}', [\App\Http\Controllers\Admin\DropshipperController::class, 'orderTrackingLinkSet']);
    Route::post('/dropshipper-order/set-tracking-link/{orderId}', [\App\Http\Controllers\Admin\DropshipperController::class, 'orderTrackingLinkStore']);
    //Set Order TrackingId....

    //Withdraw System...
    Route::get('/dropshipper-withdraw-requests', [DropshipperController::class, 'showDropshipperWithdrawRequests']);
    Route::get('/dropshipper-withdraw-approve/form/{id}', [DropshipperController::class, 'showDropshipperWithdrawApproveForm']);
    Route::post('/dropshipper-withdraw-approve', [DropshipperController::class, 'approveDropshipperWithdrawRequest']);
    Route::get('/dropshipper-withdraw-reject/{id}', [DropshipperController::class, 'rejectDropshipperWithdrawRequest']);
});
