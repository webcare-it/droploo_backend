...
use App\Http\Controllers\Admin\DropshippingApiController;
use App\Http\Controllers\Frontend\GeneralDataController;
...
//Steadfast Webhook for Order Status...
Route::post('/webhooks/steadfast/order-status', [\App\Http\Controllers\Admin\ReportController::class, 'webHookForSteadfastOrderStatusAndDropshipperPayment']);
//Steadfast Webhook for Order Status...
...
Route::get('/stock-out-products/recent', [ProductController::class, 'recentStockOutProducts']);
Route::get('/stock-out-product/details/{id}', [ProductController::class, 'getStockOutProductById']);
