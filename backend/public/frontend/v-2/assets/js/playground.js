  ...
  tabButtons.forEach((button) => {
    button.addEventListener("click", function () {
      ...
      tabButtons.forEach((btn) => {
        btn.classList.remove("bg-variableproduct", "text-white", "active");
        btn.classList.add("bg-gray-200", "text-black");
      });
      this.classList.remove("bg-gray-200", "text-black");
      this.classList.add("bg-variableproduct", "text-white", "active");
...
buttons.forEach((button) => {
  button.addEventListener("click", function () {
    buttons.forEach((btn) => {
      btn.classList.remove("bg-variableproduct", "text-white");
      btn.classList.add("bg-gray-300");
    });

    this.classList.remove("bg-gray-300");
    this.classList.add("bg-variableproduct", "text-white");
  });
});
