                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer__item-wrap">
                        ...
                        <ul class="footer__list">
                            ...
                            <li class="footer__list-item">
                                <a href="{{ url('/vendor/login/form') }}" class="footer__list-item-link">
                                    Vendor
                                </a>
                            </li>
                            <li class="footer__list-item">
                                <a href="{{ url('/dropshipper/registration-form') }}" class="footer__list-item-link">
                                    Dropshipper
                                </a>
                            </li>
                        </ul>
    ...
    <div class="footer__bottom-wrapper">
        <div class="container">
            <p class="footer__bottom-text">
                ...
                <strong class="text-brand">Nittoz</strong>
            </p>
        </div>
    </div>
</footer>
