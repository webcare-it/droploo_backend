                ...
                <div class="col">
                    <div class="card radius-10 mb-0">
                        <div class="card-body">
                            ...
                            <form id="productForm" action="{{ route('variable.products.store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="rating" value="{{ old('rating') }}" class="form-control" placeholder="Product rating"><br>
    ...
    <script type="text/javascript">
        ...
        $('#product_category').change(function() {
            ...
            if (productType === 'single') {
                ...
                // Hide size and color fields for single products
                $('#singleProductAttributes').hide();
                // Change form action to single product route
                $('#productForm').attr('action', '{{ route('products.store') }}');
            } else if (productType === 'variable') {
                $('#singleProductFields').show();
                $('#variableProductFields').show();
                // Show size and color fields for variable products
                $('#singleProductAttributes').show();
                // Change form action to variable product route
                $('#productForm').attr('action', '{{ route('variable.products.store') }}');
            } else {
