                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="wholesale_price" value="{{ $product->wholesale_price }}" class="form-control" placeholder="Product Wholesale price">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <!-- Wrap size and color fields in a container for conditional hiding -->
                                            ...
                                            <div class="form-group mt-5">
                                                ...
                                                <select class="form-control" name="vendor_id" id="vendor_id">
                                                    ...
                                                    @foreach ($vendors as $vendor)
                                                        <option value="{{ $vendor->id }}" @if ($product->vendor_id == $vendor->id)
                                                            selected
                                                        @endif>{{ $vendor->shop_name }}</option>
                                                    @endforeach
                                                </select>
...
@push('script')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            // Hide size and color fields if this is a single product
            @if(isset($product) && $product->is_variable == false)
