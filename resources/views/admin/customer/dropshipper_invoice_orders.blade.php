                    ...
                    <div class="card radius-10 mb-0">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <div>
                                        <h5 class="mb-1">Dropshipper orders</h5>
                                    </div>
                                </div>
                                <div class="col-md-4"></div>
                                <div class="col-md-4">
                                    <form action="{{ url('/dropshipper-invoice') }}" method="GET">
                                        @csrf
                                        <div class="input-group mb-3">
                                            ...
                                            <a href="{{ url('/dropshipper-invoice') }}"
                            ...
                            <div class="row">
                                ...
                                {{-- <div class="col-md-8">
                                    <form method="GET" action="{{ url('/dropshipper-invoice') }}" class="form-inline mb-3">
                                        @csrf
                                        <div class="input-group mb-3">
                                            ...
                                            <a href="{{ url('/dropshipper-invoice') }}" class="btn btn-sm btn-danger"><i class="fa fa-search"></i> Clear</a>
                                        </div>
                                    </form>
                                </div> --}}
                            </div>

                            <form action="{{ url('/process-selected-dropshipper-orders') }}" method="post">
                                @csrf
                                    ...
                                    <table class="table table-striped table-hover align-middle mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            @endif
                                                    ...
                                                    <td>{{$order->dropshipper->user_name}}</td>
                                                    <td>
