                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="input-group-wrap">
                                            ...
                                            <input type="text" name="store" class="form-control" value="Nittoz.com"
                                                readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                    ...
                    <div class="col-md-8">
                        <div class="order-details-wrap card">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" name="regular_price"
                                                    ...
                                                    value="{{ $total = $orderDetail?->qty * $orderDetail->price }}"
                                                    class="form-control" />
                                            </td>
                                            <td>
                            ...
                            <div class="card-footer text-center">
                                <button type="submit" id="submit" class="btn btn-primary btn-sm">Update
                                    Order</button>
                            </div>
                        </div>
                    </div>
