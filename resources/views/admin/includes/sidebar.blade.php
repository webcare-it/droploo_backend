<ul class="metismenu" id="menu">
    ...
    <li>
        <a class="" href="{{ url('/order/add-custom') }}">
...
{{--    </li>--}}
    <li>
        ...
        <ul>
            ...
            <li>
                <a href="{{ route('admin.variable.products.create') }}">
...
{{--            </li>--}}
    ...
    <li>
        ...
        <ul>
            ...
            <li>
                <a class="" href="{{ url('/dropshipper-order/delivery') }}">
                    <div class="parent-icon">
                        <i class='bx bx-group'></i>
                    </div>
                    <div class="menu-title">
                        Dropshipper Delivered
                    </div>
                </a>
            </li>
            <li>
    ...
    <li>
        <a class="" href="{{ url('/dropshipper-invoice') }}">
            <div class="parent-icon">
                <i class='bx bx-group'></i>
            </div>
            <div class="menu-title">
